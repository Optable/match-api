...
type Insights struct {
	...
	NetidTpids                   int32                  `protobuf:"varint,12,opt,name=netid_tpids,json=netidTpids,proto3" json:"netid_tpids,omitempty"`
...
func (x *Insights) GetNetidTpids() int32 {
	if x != nil {
		return x.NetidTpids
	}
	return 0
...
var file_match_v1_insights_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x6e, 0x65, 0x74, 0x69, 0x64, 0x54, 0x70,
